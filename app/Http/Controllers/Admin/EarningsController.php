...
class EarningsController extends Controller
{
    ...
    public function exportXlsx(Request $request, EarningsXlsxExporter $exporter): HttpResponse
    {
        ...
        $l = $isAr ? [
            ...
            'margin_profits' => 'Margin Profits',
            'free_liters' => 'Free Liters',
            'rate_margin' => 'Rate / Margin (SYP)',
            ...
            'profit' => 'Profit',
            'total' => 'Total',
            'shop_profit' => 'Shop Items',
            'shop_profit_summary' => 'Shop Profit Summary',
